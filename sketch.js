...
function redBalloon() {
  ...
  red.addImage(red_balloonImage,"red_balloon0.png");
  red.velocityX = 3;
  red.lifetime = 150;
  red.scale = 0.1;
}
...
function blueBalloon() {
  ...
  blue.addImage(blue_balloonImage,"blue_balloon0.png");
  blue.velocityX = 6;
  blue.lifetime = 150;
  blue.scale = 0.1;
}
...
function greenBalloon() {
  ...
  green.addImage(green_balloonImage,"green_balloon0.png");
  green.velocityX = 2;
  green.lifetime = 150;
  green.scale = 0.1;
}
...
function pinkBalloon() {
  ...
  pink.addImage(pink_balloonImage,"pink_balloon0.png");
  pink.velocityX = 3;
  pink.lifetime = 150;
  pink.scale = 1;
}
